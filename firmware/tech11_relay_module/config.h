...
// OLED status display (GME12864-11, 128x64, I2C) - shares the same I2C bus
// as the MCP23017 relay boards (SDA=GPIO21, SCL=GPIO22). Address 0x3C
// doesn't conflict with the MCP23017 range (0x20-0x27). Shows the 4 most
// recent production floor-call requests. See oled_display.cpp for a note
// on driver chip uncertainty (SSD1306 assumed, verify against hardware).
